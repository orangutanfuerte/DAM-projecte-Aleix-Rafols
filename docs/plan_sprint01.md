...
| ----- | ------------------------------------------------- | ------------ | -------------- | --------- |
| T1.0  | **CONFIGURAR PROJECTE**                                | Aleix Ràfols | **1.6**              | Alta      |
| T1.1  | Decidir nom i logo                                | Aleix Ràfols | 1              | Alta      |
| T1.2  | Decidir versió d'Android                          | Aleix Ràfols | 0.1              | Alta      |
| T1.3  | Inicialitzar projecte d'Android (nom app)         | Aleix Ràfols | 0.5              | Alta      |
| T2.0  | **CONFIGURAR GITHUB**                                | Aleix Ràfols | **2**              | Alta      |
| T2.1  | Preparar estructura fitxers GitHub                | Aleix Ràfols | 0.5              | Alta      |
| T2.2  | Escriure CONTRIBUTING.md i README.md              | Aleix Ràfols | 0.5              | Mitja     |
| T2.3  | Triar llicència                                   | Aleix Ràfols | 0.1              | Mitja     |
| T2.4  | Configurar .gitignore                             | Aleix Ràfols | 0.1              | Alta      |
...
- Desconeixement dels requists funcionals de l'aplicació	
- Fer una home screen poc o massa complexa
- Falta de coneixement de Kotlin i Compose	
- No saber a quina carpeta han d'anar els fitxers
- Mala planificació del temps	
